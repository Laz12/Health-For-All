    ...
    <div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <a type="button" name="add" id="add" class="btn btn-warning" href="userInsert.php"
                            data-target="#add_data_Modal">Insert</a>
                        <a type="button" name="btn_delete" id="btn_delete" class="btn btn-danger"
                            href="userDelete.php">Delete</a>
            ...
            <div id="user">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td><a type="button" name="edit" value="Edit" href="userUpdate.php"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" id="insert_form">
                ...
                <input type="submit" class="btn btn-danger" value="Delete" id="<?php echo $row["username"]; ?>">
            </form>
        </div>
    </div>
</div>
