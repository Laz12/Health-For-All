    ...
    <div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <a type="button" name="add" id="add" class="btn btn-warning" href="../Doctor_tables/treatmentInsert.php"
            ...
            <div id="user">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td><a type="button" name="edit" value="Edit" href="../Doctor_tables/treatmentUpdate.php"
