...
<body>
    <br /><br />
    <div class="container">
        <h2 align="center">Disease Data</h2>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <a type="button" name="add" id="add" class="btn btn-warning" href="DiseaseInsert.php"
                            data-target="#add_data_Modal">Insert</a>
                        <a type="button" name="btn_delete" id="btn_delete" class="btn btn-danger"
                            href="DiseaseDelete.php">Delete</a>
            ...
            <div id="user">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row["Disease_stage"]; ?></td>
                        <td><?php echo $row["Disease_transmission"]; ?></td>
                        <td><?php echo $row["Disease_communicable"]; ?></td>
                        <td><?php echo $row["Disease_fatality"]; ?></td>
                        <td><a type="button" name="edit" value="Edit" href="DiseaseUpdate.php"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" id="insert_form">
                ...
                <input type="submit" class="btn btn-danger" value="Delete" id="<?php echo $row["Disease_ID"]; ?>">
            </form>
        </div>
    </div>
</div>
