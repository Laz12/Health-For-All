...
<h1 class="text-monocase text-capitalize text-center text-light">Query 2</h1>
...
?><br/>
<?php
       $query = "SELECT Disease_name, CONCAT('$', Treatment_cost) AS Cost
                  FROM Disease a
                  LEFT JOIN Treatment b ON (Disease_ID = Treatment_Disease_ID) 
                  WHERE 1=1
                    AND Disease_name = 'Alzheimer' ";
