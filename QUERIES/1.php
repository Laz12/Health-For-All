...
<h1 class="text-monocase text-capitalize text-center text-light">Query 1</h1>
...
?><br/>
<?php
       $query = "SELECT CONCAT(Patient_first_name,' ', Patient_last_name) AS Name ,Disease_name, Disease_stage
                  FROM Patient a
            ...
            echo "<h3><th>". $row['Disease_name'] ." </h3>" ;
            echo "<h3><th>". $row['Disease_stage'] ." </h3>";
				   }
