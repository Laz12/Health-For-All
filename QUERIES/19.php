...
<h1 class="text-monocase text-capitalize text-center text-light">Query 19</h1>
...
?><br/>
<?php
       $query = "SELECT CONCAT(Patient_first_name,' ', Patient_last_name) AS Name, Region
                   FROM Patient 
            ...
            $run = mysqli_query($connection, $query);
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
                    echo "<h3><tr><th>". $row['Name'] ." </h3>";
                      echo "<h3><th>". $row['Region'] ." </th></tr></h3>";
				   }
