...
<h1 class="text-monocase text-capitalize text-center text-light">Query 13</h1>
...
?><br/>
<?php
       $query = "SELECT Region_country_short_name AS Name, Region_environment AS Environment
                  FROM Region
                  WHERE 1=1
                  AND Region_country_short_name LIKE 'Canada'
            ...
            $run = mysqli_query($connection, $query);
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
                    echo "<h3><tr><th>". $row['Name'] ." </h3>";
                        echo "<h3><th>". $row['Environment'] ." </th></tr></h3>";
				   }
