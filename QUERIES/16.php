...
<h1 class="text-monocase text-capitalize text-center text-light">Query 16</h1>
...
?><br/>
<?php
       $query = "SELECT Doctor_name AS Name, Doctor_start_date AS Beginning 
                  FROM Doctor";
            ...
            $run = mysqli_query($connection, $query);
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
                    echo "<h3><tr><th>". $row['Name'] ." </h3>";
                        echo "<h3><th>". $row['Beginning'] ." </th></tr></h3>";
				   }
