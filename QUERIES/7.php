...
<h1 class="text-monocase text-capitalize text-center text-light">Query 7</h1>
...
?><br/>
<?php
       $query = "SELECT Disease_ID AS ID, Disease_name AS Name, Disease_transmission AS Transmission
                  FROM Disease
                  WHERE 1=1
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
                    echo "<h3><tr><th>". $row['ID'] ." </h3>";
                      echo "<h3><th>". $row['Name'] ." </h3>" ;
                        echo "<h3><th>". $row['Transmission'] ." </th></tr></h3>";
				   }
