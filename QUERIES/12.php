...
<h1 class="text-monocase text-capitalize text-center text-light">Query 12</h1>
...
?><br/>
<?php
       $query = "SELECT CONCAT(Patient_first_name,' ', Patient_last_name) AS Name, Medical_Check_up_documentation AS Documentation
