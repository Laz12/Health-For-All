...
<h1 class="text-monocase text-capitalize text-center text-light">Query 6</h1>
...
?><br/>
<?php
       $query = "SELECT CONCAT(Patient_first_name,' ',Patient_last_name) AS 'Patients', Medical_Check_up_date AS Visit
