...
<h1 class="text-monocase text-capitalize text-center text-light">Query 17</h1>
...
?><br/>
<?php
       $query = " SELECT CONCAT(Patient_first_name, ' ', Patient_last_name) AS Patient, Region, Disease_name AS Disease
                  FROM Patient a
                  JOIN Region b ON (Patient_ID = Region_Patient_ID)
                  JOIN Disease c ON (c.Disease_ID = b.Region_Disease_ID)
