...
?><br/>
<?php
         $query = "SELECT CONCAT(Patient_first_name,' ', Patient_last_name) AS Name ,Medical_Check_up_date AS Last_Checkup
            ...
            $run = mysqli_query($connection, $query);
				   ...
				   while($row = mysqli_fetch_array($run))
				   {
                    echo "<h3><tr><th>". $row['Name'] ." </h3>";
                        echo "<h3><th>". $row['Last_Checkup'] ." </th></tr></h3>";
				   }
