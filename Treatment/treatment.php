...
<body>
    <br /><br />
    <div class="container">
        <h2 align="center">Treatment Data</h2>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <a type="button" name="add" id="add" class="btn btn-warning" href="treatmentInsert.php"
                            data-target="#add_data_Modal">Insert</a>
                        <a type="button" name="btn_delete" id="btn_delete" class="btn btn-danger"
                            href="treatmentDelete.php">Delete</a>
                        ...
                        <td>
                            <span class="custom-checkbox">
                                <input type="checkbox" id="checkbox1" name="checkbox"
                                    value="<?php echo $row["Treatment_ID"]; ?>">
                                <label for="checkbox1"></label>
                            </span>
                        </td>
                        <td><?php echo $row["Treatment_ID"]; ?></td>
                        <td><?php echo $row["Treatment_stage"]; ?></td>
                        <td><?php echo $row["Treatment_cost"]; ?></td>
                        <td><?php echo $row["Treatment_option"]; ?></td>
                        <td><a type="button" name="edit" value="Edit" href="treatmentUpdate.php"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" id="insert_form">
                ...
                <input type="submit" class="btn btn-danger" value="Delete" id="<?php echo $row["Treatment_ID"]; ?>">
            </form>
        </div>
    </div>
</div>
