...
<?php
    ...
    if (isset($_POST['register'])) {
        ...
        if ($result) {
            ...
            $query->bindParam("Disease_stage", $Disease_stage, PDO::PARAM_INT);
            $query->bindParam("Disease_transmission", $Disease_transmission, PDO::PARAM_STR);
        ...
        header("Location: ../Doctor_credential/ddisease.php");
    }
?>