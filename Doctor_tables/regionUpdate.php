...
<?php
    ...
    if (isset($_POST['register'])) {
        ...
        if ($result) {
            $query = $connection->prepare("UPDATE Region SET Region_country_code=:Region_country_code, Region_country_short_name=:Region_country_short_name, Region_nationality=:Region_nationality,Region=:Region,Region_environment=:Region_environment WHERE Region_country_code=:Region_country_code");
            $query->bindParam("Region_country_code", $Region_country_code, PDO::PARAM_STR);
        ...
        header("Location: ../Doctor_credential/dregion.php");
    }
?>